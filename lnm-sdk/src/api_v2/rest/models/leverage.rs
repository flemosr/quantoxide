...
use super::{
    SATS_PER_BTC, error::LeverageValidationError, margin::Margin, price::Price, serde_util,
};
...
///
/// ```
/// use lnm_sdk::api_v2::models::Leverage;
///
...
impl Leverage {
    ...
    ///
    /// ```
    /// use lnm_sdk::api_v2::models::{Leverage, Quantity, Margin, Price};
    ///
