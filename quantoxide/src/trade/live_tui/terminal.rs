...
pub struct LiveTuiTerminal(Mutex<TerminalState>);

impl LiveTuiTerminal {
    pub fn new() -> Result<Arc<Self>> {
        enable_raw_mode().map_err(|e| LiveTuiError::Generic(e.to_string()))?;
        let mut stdout = io::stdout();
        execute!(stdout, EnterAlternateScreen, EnableMouseCapture)
            .map_err(|e| LiveTuiError::Generic(e.to_string()))?;
        let backend = CrosstermBackend::new(stdout);
        let terminal = Terminal::new(backend).map_err(|e| LiveTuiError::Generic(e.to_string()))?;
    ...
    pub fn draw(&self, tui_content: &LiveTuiView) -> Result<()> {
    ...
    pub fn restore(&self) -> Result<()> {
        ...
        disable_raw_mode().map_err(|e| LiveTuiError::Generic(e.to_string()))?;
        execute!(
